...
ubuntu_image = "fd8pecdhv50nec1qf9im" # yandex.get_compute_image_output(family="ubuntu-2204-lts")
...
y = pulumi.Config("yandex")
yc_token = y.require("ycToken")
...
subnet = yandex.VpcSubnet("subnet",
    ...
    network_id=network.id) #vpc_network_id)
vm = yandex.ComputeInstance("vm",
    ...
    network_interfaces=[{
        "subnet_id": subnet.id, #vpc_subnet_id,
        "nat": True,
    }],
    metadata={
