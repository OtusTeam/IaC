...
# some parts from: https://github.com/yandex-cloud/python-sdk/blob/master/examples/compute/main.py
...
# next 2 lines added by JA:
    print(f"{arguments.network_id=}")
    print(f"{arguments.subnet_id=}")
...
# next 2 lines added by JA:
    parser.add_argument(
        '--network-id', help='Network/VPC ID.')
    parser.add_argument(
