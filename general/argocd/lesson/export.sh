...
export YC_PREFIX="yc-lesson" 				# and group in gitlab
export YC_PROJECT="infra"				# in gitlab
export YC_GL="main"					# gitlab managet service name in YC
export YC_SG="$YC_PREFIX-sg"                            # security-group
export YC_SA="$YC_PREFIX-kube-infra"                    # service-account and kubernates managet service name in YC  
...
export YC_NG="$YC_SA-group-1"                           # node group
